        ...
        return (
            ...
            <div className="row">
                    ...
                    <div className="col-sm-4 servicesImage three">
                        <h5>Patios</h5>
                        <p>Our Eco friendly Westermann cleaner avoid the use of nasty chemicals or water</p>
                    </div>                    
                </div>
                <div className="row">
                    <div className="col-sm-4 servicesImage four">
                        <h5>Tarmac</h5>
                        <p>Our bespokem, high powered jet wash cleaning system will restore your tarmac and bring it back to lofe </p>
                </div>
                    <div className="col-sm-4 servicesImage five">
                        <h5>Windows</h5>
                        <p>Using a pure water system followed by an airdry finish means a streak free window cleaning service</p>
                </div>
                    <div className="col-sm-4 servicesImage six">
                        <h5>Other Jobs</h5>
                        <p>Get in touch as we provide many other services.  </p>
                    </div>                    
                </div>
                </div>
        )
