...
export class WaysOfWorking extends Component {
    render() {
        return (
            <div className="aboutRow aboutRowMobile">
                    <div className="col-sm-12 col-md-6">
                    <h1 className="aboutHead aboutMobileHead">Simon - WeedPro UK</h1>
                ...
                <div className="col-sm-12 col-md-6">
                    <div className="aboutContainer">
                        <img className="aboutImg aboutImgMobile" src={Simon} alt="A westermann cleaner with a cleared pile of debris"/>
                    </div>
                    </div>              
                </div>
        )
