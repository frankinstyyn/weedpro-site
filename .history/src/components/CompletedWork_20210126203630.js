...
export class CompletedWork extends Component {
  ...
  <div class="row">
    <div class="col">
      <img className="wowImage" src={work1} alt="A pile of debris for the preperation work for the job"/>
    </div>
    <div class="col">
      <img className="wowImage" src={work2} alt="A pile of debris for the preperation work for the job"/>
    </div>
    <div class="col">
      <img className="wowImage" src={work3} alt="A pile of debris for the preperation work for the job"/>
    </div>
  </div>
</div>
                </div>
