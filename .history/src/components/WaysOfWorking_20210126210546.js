            ...
            <div class="servicesHead">
                ...
                <div className="wowRow">
                    ...
                    <div className="col-sm-12 col-md-4">
                            ...
                            <p id="#completedWork">The cleaning is complete and we'll complete a final inspection of the area to ensure a high quality finish with 100% customer satisfaction</p>
                </div>
