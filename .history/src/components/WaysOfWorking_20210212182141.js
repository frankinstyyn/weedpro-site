            ...
            <div class="servicesHead">
                ...
                <div className="wowRow">
                    ...
                    <div className="col-sm-12 col-md-4">
                            ...
                            <p>The cleaning is complete and we'll complete a final inspection of the area to ensure a high quality finish with 100% customer satisfaction. We will also re-sand, where necessary, at no additional cost!<span id="completedWork"></span></p>
                    </div>               
                </div>
            </div>
        )
