            ...
            <div className="row">
                ...
                <div>
                        ...
                        <div class="ctas">
                            ...
                            <div className="row">
                                <div class="col-sm-6">
                                    <span><a href="https://www.facebook.com/Weedpro-Ukcom-100145041372858/" className="fb-btn-services"><span className="bannerIcon"><FiFacebook /></span>- Weedpro-uk.com</a></span>
                                </div>
                                <div class="col-sm-6">
                                    <span><a href="https://www.instagram.com/weedprouk/" id="ourServices" className="btn-services"><span className="bannerIcon"><FiInstagram /></span>- Weedprouk</a></span>
                                    </div>
                                </div>
                            </div>
                    </div>
