...
export default function ContactForm() {
    ...
    function closePopUp() {
        ...
        document.getElementById('closePopUp').setAttribute("class", "closePopUp")
    }
    // This shows the SVG on the popup
    // function showSvg() {
    //     document.getElementById('closePopUp').setAttribute("class", "closeMsg svg")
    // }
    // This closes the SVG on click
    // function closeSvg() {
    //     document.getElementById('closePopUp').setAttribute("class", "closePopUp")
    // }
        ...
        return (
            <div className="bannerForm">
                ...
                <form onSubmit={sendEmail} onReset={myPopUp}>
                    ...
                    <div id="closePopUp" className="closeMsg">
